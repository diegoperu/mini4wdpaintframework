...
**HEADER (C001):** Violet band VioletPrimary, 18mm. Left: "Mini4WD Manual". Right: "MATERIALS".
**FOOTER (C002):** Gray band LightGray, 12mm. Center: "{{project.modelName}} — Materials  |  P003".

**PAGE TITLE (below header, 22mm from top):**
"What You Will Need" in Bebas Neue Bold 28pt VioletPrimary, left margin 18mm.
...
Section heading: "PAINTS" in Source Sans Pro SemiBold 10pt VioletPrimary uppercase, with 2px violet underline spanning column width.
...
- Paint Code Box (C011): 36mm wide, violet border 1.5px VioletPrimary, border-radius 3px, brand 7pt MidGray above code 10pt Bebas Neue VioletPrimary
- Color name: Source Sans Pro SemiBold 9pt Black
- Finish tag: small pill badge, background #F5F0FA, text Source Sans Pro Regular 7pt VioletPrimary, border-radius 10px

Separate each row with a 1px LightGray hairline.

RIGHT COLUMN — TOOLS & SUPPLIES:

Section heading: "TOOLS & SUPPLIES" in Source Sans Pro SemiBold 10pt VioletPrimary uppercase, with 2px violet underline.

Sub-section "TOOLS" (icon: wrench glyph or [T]):
For each tool in {{materials.tools}}:
- Bullet: small filled circle VioletPrimary, 4px diameter
...
- Bullet: open circle VioletPrimary, 4px diameter
