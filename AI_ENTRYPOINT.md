...
| Page content | `ApprovedAssets/Text/P00x/content.yaml` | Primary per page |
| Project data | `Projects/{ModelName}/PROJECT.yaml` | Overrides prompt defaults |
...
### Render Mode (Phase 3)
- Input: `ApprovedAssets/Text/P00x/content.yaml` (locked, approved)
...
`ApprovedAssets/` is the CMS layer. Each page (P001–P010) is a self-contained module:
...
[ ] ApprovedAssets/index.yaml updated
```
...
- [x] Projects/{ModelName}/PROJECT.yaml
